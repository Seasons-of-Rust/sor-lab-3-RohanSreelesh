...
impl Shop {
    ...
    fn most_expensive(&self) -> u32 {
        let mut current_most_expensive: u32 = 0;
        for current_card in &self.cards {
            if current_card.price > current_most_expensive {
                current_most_expensive = current_card.price;
            }
        }
        current_most_expensive
    }
    ...
    fn total_damage(&self) -> u32 {
        ...
        for current_card in &self.cards {
            total_damage += current_card.damage;
        }
        total_damage
    }
    ...
    fn total_health(&self) -> u32 {
        ...
        for current_card in &self.cards {
            total_health += current_card.health;
        }
        total_health
    }
}
